...
class LLMProvider(ABC):
    ...
    def __init__(self, api_key: Optional[str] = None, model: Optional[str] = None, base_url: Optional[str] = None):
        ...
        self.banned_keywords = ["DROP", "UPDATE", "DELETE", "INSERT", "CREATE", "ALTER", "TRUNCATE"]
...
class OllamaProvider(LLMProvider):
    ...
    def __init__(self, api_key: str = "ollama", model: str = "llama3.2:3b", base_url: str = "http://localhost:11434", 
                 enable_gpu: bool = False, gpu_device: Optional[str] = None):
...
def create_llm_provider(provider_type: Optional[str], api_key: Optional[str] = None, 
                       model: Optional[str] = None, base_url: Optional[str] = None,
                       enable_gpu: bool = False, gpu_device: Optional[str] = None) -> LLMProvider:
