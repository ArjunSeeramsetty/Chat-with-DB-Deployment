    ...
    def _load_entities(self) -> None:
        ...
        try:
            ...
            self._entities = {
                ...
                "comparison_keywords": entity_recognition.get(
                    "comparison_keywords", []
                ),
            ...
            logger.info(
                f"Loaded {len(self._entities['indian_states'])} states, {len(self._entities['indian_regions'])} regions from {self.config_path}"
            )
